...
public class ReportingService {
    ...
    public ReportingEventMessage getAllPayments() {
        ...
        CompletableFuture<ReportingEventMessage> getPaymentsFuture = new CompletableFuture<>();
    ...
    public ReportingEventMessage getAllCustomerPayments(UUID customerId) {
        CorrelationId correlationId = CorrelationId.randomId();
        CompletableFuture<ReportingEventMessage> getCustomerPaymentsFuture = new CompletableFuture<>();
